...
//                StateNumberOfModel frontnumber = statisticModel1.statenumber.get(fromState);
//                StateNumberOfModel nextnumber  = statisticModel1.statenumber.get(toState);
...
////            for(Map.Entry<String,StateNumberOfModel> statenumber : statisticModel1.statenumber.entrySet()){
